...
const addBikeForm = `\
  <div class="main__container--service">\
    <div class="container__header">\
      ...
      <p>New ride? Sweet! Just add it in here to make service simple should you ever need it.</p>\
    </div>
      <div class="container__supporting--form">\
        <form>
          <fieldset>
...
const guestForm = `<div class="main__container--service">
      <div class="container__header">
        ...
        <p>Just provide us with your contact information and some for your bike and we'll get things going.</p>
